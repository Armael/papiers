...
(* OASIS_START *)
(* DO NOT EDIT (digest: d823efe1a9500d105f3d85b305c36afe) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Arma\195\171l Gu\195\169neau"];
          homepage = None;
          bugreports = None;
          synopsis =
            "A tool to index your articles/books/... and quickly search\nthrough them";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cpdf", None);
                           FindlibPackage ("camlpdf", None);
                   ...
                   {
                      lib_modules = ["Papierslib"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Papierslib_preludelib";
                           "Papierslib_inner_db";
                           "Papierslib_source";
                           "Papierslib_query";
                           "Papierslib_formatInfos";
                           "Papierslib_archive"
                        ];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "papierslib";
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("ANSITerminal", None);
                   ...
                   {exec_custom = false; exec_main_is = "papiers.ml"});
               Doc
                 ({
                     cs_name = "papierslib_api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "API reference for Papierslib";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "}*\132R\185ej\187\182\1795\181,\202\165\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
